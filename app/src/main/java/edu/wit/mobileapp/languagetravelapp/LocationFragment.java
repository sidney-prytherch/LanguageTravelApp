    ...
    class GetData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String searchQuery = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=restaurants+in+Portugal&fields=formatted_address,name,rating,opening_hours&key="+apiKey;
